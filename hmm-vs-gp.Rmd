...
To determine if a brain area is sampling from options or integrating to a threshold, we can record neural activity from that area, and decode the probability that the brain area is representing one option over the other.  If the probability starts somewhere in the middle and  
...
For more information on Gaussian processes in general, Carl Rasmussen and Christopher Williams have written a [great textbook](http://www.gaussianprocess.org/gpml/) on GPs which is free.
