...
Another problem with the Stan model so far is they only handle a single subject.  We want our models to include mixed effects (inter-subject variablility).  So, we'll build multilevel versions of both the Gaussian process and hidden Markov models which can handle multiple trials from multiple subjects.

TODO: show stan routines
