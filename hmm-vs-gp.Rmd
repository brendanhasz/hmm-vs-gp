...
The trace plots also indicate that the chains explored similar areas of parameter space, and that the warmup period was long enough.
...
TODO: talk about features of that: 1) posterior pulled away from prior towards true value, 2) pulled closer for state 2 b/c there were more datapoints generated by state 2
