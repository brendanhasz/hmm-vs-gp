...
This results in a distribution which is defined $>0$, and has a low density at higher values.

```{r}
alpha_prior <- function(x) 2*dnorm(x, 0, 2)
...
```{r}
sigma_prior <- function(x) 2*dnorm(x, 0, 1)
